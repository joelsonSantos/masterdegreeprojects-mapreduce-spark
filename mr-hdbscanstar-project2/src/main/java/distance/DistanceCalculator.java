...
/**
 * An interface for classes which compute the distance between two points (where
 * points are represented as arrays of doubles).
 * 
 * @author zjullion
 */
public interface DistanceCalculator {
	...
	/**
	 * Computes the distance between two points. Note that larger values indicate
	 * that the two points are farther apart.
	 * 
